...
4. Drive it. Capture evidence to the scratchpad: screenshots, response bodies, log lines, exit codes. Run the command in this reply; a pass claimed from an earlier run is not a pass.
