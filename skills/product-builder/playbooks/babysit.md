...
4. Rebase, push, re-run **product-builder-verify** after changes, and **product-builder-review** `--fix-wave` on each fix commit that answers a comment or a failing check, before the thread is resolved.
