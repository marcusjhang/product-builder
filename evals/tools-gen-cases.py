...
CASES = [
 # ---------------- playbooks
 dict(name="playbook-investigation", tags=["playbook","tier2"], scaffold=BASE+" tb_layer_shipped_snooze; tb_origin",
 ...
 dict(name="playbook-plan-bounded", tags=["playbook","tier2","flow"], scaffold=BASE+" tb_layer_shipped_snooze; tb_origin",
 ...
 dict(name="playbook-plan-feature", tags=["playbook","tier2","flow","team"], scaffold=BASE+" tb_origin",
 ...
 dict(name="playbook-plan-program", tags=["playbook","tier2","flow"], scaffold=BASE+" tb_origin",
 ...
 dict(name="playbook-revise", tags=["playbook","tier2","flow"], scaffold=BASE+" tb_layer_plan 'Ready to implement'; tb_origin",
 ...
 dict(name="playbook-implement", tags=["playbook","tier2","flow","team"], scaffold=BASE+" tb_layer_plan 'Ready to implement'; tb_layer_pathread_test; tb_origin",
 ...
 dict(name="playbook-ship", tags=["playbook","tier2","flow"], scaffold=BASE+" tb_layer_plan 'Ready to implement'; tb_layer_p1_merged; tb_plan_status keyboard-archive 'QA passed'; tb_origin",
 ...
 dict(name="playbook-bug-fix", tags=["playbook","tier2","flow","team"], scaffold=BASE+" tb_layer_bug_complete_archived; tb_origin",
 ...
 dict(name="playbook-refactoring", tags=["playbook","tier2","flow"], scaffold=BASE+" tb_origin",
 ...
 dict(name="playbook-perf-issue", tags=["playbook","tier2","flow"], scaffold=BASE+" tb_layer_slow; tb_origin",
 ...
 dict(name="playbook-babysit", tags=["playbook","tier2","flow"], scaffold=BASE+" tb_layer_pathread_test; tb_layer_built_branch; tb_layer_open_pr; tb_origin; git checkout -q feature/priority-filter",
 ...
 dict(name="playbook-pickup", tags=["playbook","tier2"], scaffold=BASE+" tb_layer_plan 'Ready to implement'; tb_plan_status keyboard-archive Implementing; tb_layer_slice_branch; tb_origin; git checkout -q keyboard-archive/p1-archive-button",
 ...
 dict(name="playbook-pause", tags=["playbook","tier2"], scaffold=BASE+" tb_layer_plan 'Ready to implement'; tb_plan_status keyboard-archive Implementing; tb_layer_slice_branch; tb_origin; git checkout -q keyboard-archive/p1-archive-button; echo '// wip' >> src/cli.js",
 ...
 dict(name="playbook-opening-a-pr", tags=["playbook","tier2","flow"], scaffold=BASE+" tb_layer_pathread_test; tb_layer_built_branch; tb_origin; git checkout -q feature/priority-filter",
 ...
 dict(name="playbook-built-first", tags=["playbook","tier2","flow","team"], scaffold=BASE+" tb_layer_pathread_test; tb_layer_built_branch; tb_origin; git checkout -q feature/priority-filter",
 ...
 dict(name="playbook-incident", tags=["playbook","tier2","flow"], scaffold=BASE+" tb_layer_incident; tb_origin",
 ...
 dict(name="playbook-spike", tags=["playbook","tier2","flow"], scaffold=BASE+" tb_layer_vendored_dep; tb_origin",
 ...
 dict(name="playbook-dependency-upgrade", tags=["playbook","tier2","flow","team"], scaffold=BASE+" tb_layer_vendored_dep; tb_origin",
 ...
 dict(name="playbook-data-migration", tags=["playbook","tier2","flow","team"], scaffold=BASE+" tb_origin",
 ...
 dict(name="playbook-removal", tags=["playbook","tier2","flow"], scaffold=BASE+" tb_layer_dead_flag; tb_origin",
 ...
 dict(name="playbook-flaky-test", tags=["playbook","tier2","flow"], scaffold=BASE+" tb_layer_flaky; tb_origin",
 ...
 dict(name="playbook-release", tags=["playbook","tier2","flow"], scaffold=BASE+" tb_layer_release_commits; tb_origin",
 ...
 dict(name="playbook-decision-record", tags=["playbook","tier2"], scaffold=BASE+" tb_origin",
 ...
 dict(name="playbook-hardening", tags=["playbook","tier2","flow","team"], scaffold=BASE+" tb_layer_thin_import; tb_origin",
